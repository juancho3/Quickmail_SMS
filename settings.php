...
if($ADMIN->fulltree) {
    ...
    $settings->add(
        new admin_setting_configtext('block_quickmail_smsmail',
            quickmail::_s('smsmail'), quickmail::_s('smsmail_desc'), 'sms@gateway.mail.com'
        )
    );

    $settings->add(
        new admin_setting_configtext('block_quickmail_smsprefix',
            quickmail::_s('smsprefix'), quickmail::_s('smsprefix_desc'), 'SITENAME'
        )
    );
