...
$string['smsmail'] = 'SMS mail';
$string['smsmail_desc'] = 'SMS mail account to send SMS thorugh';
$string['smsprefix'] = 'SMS prefix';
$string['smsprefix_desc'] = 'SMS prefix to prepend on output SMS';
