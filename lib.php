...
abstract class quickmail {
    ...
    static function load_config($courseid) {
        ...
        if (empty($config)) {
            ...
            $smsmail = get_config($m, 'block_quickmail_smsmail');
            $smsprefix = get_config($m, 'block_quickmail_smsprefix');
    ...
    public static function get_non_suspended_users($context, $courseid){
        ...
        $sql = "SELECT u.id, u.firstname, u.lastname, u.email, u.mailformat, u.suspended, u.maildisplay, ue.status, u.phone1, u.phone2
            FROM {user} as u
